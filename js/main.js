(function () {
  ...
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('https://pablo63leiva-alt.github.io/blue-collar-hustle-hub/sw.js').catch(function () {});
  }
    ...
    modal.innerHTML = `
      ...
      <div class="exit-modal-content">
        ...
        <form class="exit-modal-form" action="#" method="POST">
          <input type="hidden" name="_next" value="https://pablo63leiva-alt.github.io/blue-collar-hustle-hub/assets/trade-lift-5-trades.pdf">
        ...
        <div class="exit-modal-success hidden" aria-live="polite">
          ...
          <a href="https://pablo63leiva-alt.github.io/blue-collar-hustle-hub/assets/trade-lift-5-trades.pdf" class="btn btn-primary exit-modal-download" download>Download PDF Now</a>
        </div>
      </div>
    `;
